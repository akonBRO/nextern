...
export function applicationStatusEmailTemplate(params: {
  ...
  const CONFIG: Record<ApplicationStatusEmailStatus, Cfg> = {
    // ── Under Review ────────────────────────────────────────────────────
    under_review: {
      subject: `Your application for ${jobTitle} is currently under review`,
      accentColor: '#F59E0B',
    ...
    assessment_sent: {
      ...
      body: `
        <p style="margin:0 0 14px;color:#374151;font-size:14px;line-height:1.85;">
          ...
          by the ${companyName} hiring team. It is designed to evaluate your aptitude, subject knowledge,
    ...
    interview_scheduled: {
      ...
      body: `
        <p style="margin:0 0 14px;color:#374151;font-size:14px;line-height:1.85;">
          Reaching the interview stage is a meaningful achievement and reflects the quality of your candidacy.
          The complete details of your interview — including the confirmed date, time, format, and any
          specific preparation instructions from ${companyName} — are available within your Nextern
          application tracker.
        </p>
        <p style="margin:0 0 14px;color:#374151;font-size:14px;line-height:1.85;">
        ...
        <ul style="margin:0 0 14px;padding-left:20px;color:#374151;font-size:14px;line-height:2.0;">
          ...
          <li>Prepare structured examples using the STAR method for behavioural questions</li>
          <li>Verify your technical setup in advance if the interview is conducted via video</li>
    ...
    // ── Hired ──────────────────────────────────────────────────────────
    hired: {
      subject: `Congratulations — you have been selected for ${jobTitle} at ${companyName}`,
      accentColor: '#10B981',
      badgeLabel: 'Selected',
      badgeBg: '#ECFDF5',
      badgeText: '#065F46',
    ...
    // ── Rejected ───────────────────────────────────────────────────────
    rejected: {
      subject: `Application outcome — ${jobTitle} at ${companyName}`,
      accentColor: '#64748B',
