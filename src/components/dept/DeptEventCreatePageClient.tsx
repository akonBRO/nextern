...
export default function DeptEventCreatePageClient() {
      ...
      >
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px' }}>
          ...
          <p style={{ color: C.gray, fontSize: 13 }}>
            Publish academic events for students across your department and institution.
          </p>
        </div>
      </div>
          ...
          <div style={{ padding: '32px 36px', display: 'flex', flexDirection: 'column', gap: 22 }}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                ...
                <Field label="Year of Study (blank = all)" required={false}>
