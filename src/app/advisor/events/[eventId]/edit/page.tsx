...
export default function EditAdvisorEventPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setSaved(true);
      setTimeout(() => router.push('/advisor/events'), 1200);
    } catch {
      ...
      >
        <div style={{ maxWidth: 720, margin: '0 auto', padding: '0 24px' }}>
          ...
          <p style={{ color: C.gray, fontSize: 13 }}>
            Update your event details. Changes are saved and reflected immediately.
          </p>
        </div>
      </div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 700,
                fontFamily: 'var(--font-display)',
                boxShadow: loading || saved ? 'none' : '0 4px 12px rgba(124,58,237,0.35)',
              }}
            >
