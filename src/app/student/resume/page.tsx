      ...
      <div style={{ background: C.indigoDeep, borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 28px' }}>
          ...
          >
            ...
            {/* ── CONSOLIDATED ACTION GROUP — 3 distinct actions, clear hierarchy ── */}
            <div
              style={{
                display: 'none',
                alignItems: 'center',
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  padding: '9px 18px',
                  background:
                    btnDisabled && generating ? 'rgba(37,99,235,0.6)' : 'rgba(37,99,235,0.9)',
                  color: '#fff',
                  border: 'none',
                  borderRadius: 9,
                  fontSize: 13,
                  ...
                  transition: 'all 0.15s',
                  whiteSpace: 'nowrap',
                  opacity: btnDisabled && saving ? 0.5 : 1,
                }}
              >
                {generating ? (
                  <>
              ...
              <button
                ...
                style={{
                  ...
                  gap: 7,
                  padding: '9px 18px',
                  background: saving ? 'rgba(13,148,136,0.6)' : 'rgba(13,148,136,0.9)',
                  color: '#fff',
                  border: 'none',
                  borderRadius: 9,
                  fontSize: 13,
                  ...
                  transition: 'all 0.15s',
                  whiteSpace: 'nowrap',
                  opacity: btnDisabled && generating ? 0.5 : 1,
                }}
              >
                {saving ? (
                  <>
